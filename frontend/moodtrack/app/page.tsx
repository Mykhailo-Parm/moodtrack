  ...
  return (
    <div className="font-shadows basis-3/4 flex flex-col p-3">
      ...
      <div className="lg:grid lg:grid-rows-3 lg:grid-cols-3 lg:gap-5 mt-10 justify-items-center hidden">
        ...
        <div className="grid-cols-subgrid grid-rows-subgrid row-span-2 col-span-2 p-3 dark:bg-nordic-purple-900 bg-green-100 flex flex-col justify-center w-full items-center">
